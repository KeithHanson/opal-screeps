...
Opal.modules["debug"] = function(Opal) {
  ...
  Opal.add_stubs(['$puts', '$strftime', '$now', '$+', '$*']);
  return (function($base, $super, $parent_nesting) {
    function $Debug(){};
    var self = $Debug = $klass($base, $super, 'Debug', $Debug);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Debug_debug_1, TMP_Debug_always_log_2, TMP_Debug_separator_3;

    
    Opal.const_set($nesting[0], 'DEBUG', true);
    Opal.defs(self, '$debug', TMP_Debug_debug_1 = function $$debug(msg) {
      var self = this;

      if ($truthy(Opal.const_get_relative($nesting, 'DEBUG'))) {
        return self.$puts("" + "(DEBUG) " + (Opal.const_get_relative($nesting, 'Time').$now().$strftime("%H:%M:%S")) + " | " + (msg))
        } else {
        return nil
      }
    }, TMP_Debug_debug_1.$$arity = 1);
    Opal.defs(self, '$always_log', TMP_Debug_always_log_2 = function $$always_log(msg) {
      var self = this;

      return self.$puts("" + (Opal.const_get_relative($nesting, 'Time').$now().$strftime("%H:%M:%S")) + " | " + (msg))
    }, TMP_Debug_always_log_2.$$arity = 1);
    return Opal.defs(self, '$separator', TMP_Debug_separator_3 = function $$separator(msg) {
      var self = this;

      return self.$puts($rb_plus($rb_plus($rb_times("*", 10), "" + "(DEBUG: " + (Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Debug'), 'DEBUG')) + " | " + (Opal.const_get_relative($nesting, 'Time').$now().$strftime("%H:%M:%S")) + ") " + (msg)), $rb_times("*", 10)))
    }, TMP_Debug_separator_3.$$arity = 1);
  })($nesting[0], null, $nesting)
};
...
Opal.modules["strategy_supervisor"] = function(Opal) {
  ...
  Opal.add_stubs(['$new', '$debug', '$calculate_strategy']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$initialize', TMP_StrategySupervisor_initialize_3 = function $$initialize() {
      ...
      return (Opal.class_variable_set($StrategySupervisor, '@@strategy', "begin"))
    ...
    Opal.defn(self, '$calculate_strategy', TMP_StrategySupervisor_calculate_strategy_4 = function $$calculate_strategy() {
      ...
      return Opal.const_get_relative($nesting, 'Debug').$debug("" + "Strategy Calculated: " + ((($a = $StrategySupervisor.$$cvars['@@strategy']) == null ? nil : $a)));
    ...
    return Opal.defs(self, '$strategy', TMP_StrategySupervisor_strategy_5 = function $$strategy() {
      ...
      return (($a = $StrategySupervisor.$$cvars['@@strategy']) == null ? nil : $a)
...
Opal.modules["creep"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$creep_obj=', '$-', '$[]', '$creep_obj', '$name=', '$ttl=']);
  return (function($base, $super, $parent_nesting) {
    function $Creep(){};
    var self = $Creep = $klass($base, $super, 'Creep', $Creep);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Creep_initialize_1;

    
    self.$attr_accessor("creep_obj", "name", "ttl");
    return (Opal.defn(self, '$initialize', TMP_Creep_initialize_1 = function $$initialize(creep_object) {
      var self = this, $writer = nil;

      
      
      $writer = [creep_object];
      $send(self, 'creep_obj=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      ...
      return $writer[$rb_minus($writer["length"], 1)];;
    }, TMP_Creep_initialize_1.$$arity = 1), nil) && 'initialize';
  })($nesting[0], null, $nesting)
};
...
Opal.modules["room"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_accessor', '$name=', '$-', '$creeps=', '$each', '$find', '$screeps_room', '$<<', '$creeps', '$new', '$debug', '$length', '$name', '$[]', '$ttl']);
...
if (creep_obj == null) creep_obj = nil;
      return self.$creeps()['$<<'](Opal.const_get_relative($nesting, 'Creep').$new(creep_obj))}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1));
...
if (creep == null) creep = nil;
      return Opal.const_get_relative($nesting, 'Debug').$debug("" + "Creep: " + (creep.$name()) + " TTL: " + (creep.$ttl()))}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4));
...
Opal.modules["war_supervisor"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_accessor', '$supervisors=', '$-', '$shared', '$strategy_supervisor=', '$military_supervisor=', '$<<', '$supervisors', '$strategy_supervisor', '$military_supervisor', '$rooms=', '$new', '$debug', '$each', '$tick!', '$[]', '$rooms']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_WarSupervisor_initialize_1, TMP_WarSupervisor_shared_2, TMP_WarSupervisor_tick$B_6;

    
    self.$attr_accessor("supervisors", "strategy_supervisor", "military_supervisor", "rooms");
    ...
    return (Opal.defn(self, '$tick!', TMP_WarSupervisor_tick$B_6 = function() {
      var TMP_3, TMP_4, TMP_5, self = this, $writer = nil;
...
if (s == null) s = nil;
      ...
      $send(self, 'rooms=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      $send(Opal.const_get_relative($nesting, 'GAME')['$[]']("rooms"), 'each', [], (TMP_4 = function(room_name){var self = TMP_4.$$s || this;
if (room_name == null) room_name = nil;
      return self.$rooms()['$<<'](Opal.const_get_relative($nesting, 'Room').$new(room_name))}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4));
      $send(self.$rooms(), 'each', [], (TMP_5 = function(room){var self = TMP_5.$$s || this;
if (room == null) room = nil;
      return room['$tick!']()}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5));
      return Opal.const_get_relative($nesting, 'Debug').$debug("WarSupervisor Tock!");
    }, TMP_WarSupervisor_tick$B_6.$$arity = 0), nil) && 'tick!';
  })($nesting[0], null, $nesting);
};
