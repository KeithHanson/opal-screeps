...
Opal.modules["debug"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return Opal.defs(self, '$separator', TMP_Debug_separator_3 = function $$separator(msg) {
      ...
      return self.$puts($rb_plus($rb_plus($rb_times("*", 10), "" + " " + (msg) + " " + (Opal.const_get_relative($nesting, 'Time').$now().$strftime("%H:%M:%S")) + " "), $rb_times("*", 10)))
...
/* Generated by Opal 0.11.4 */
Opal.modules["body_parts"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;
  ...
  return Opal.const_set($nesting[0], 'GAME', self.$Native(Game));
};
...
Opal.modules["strategy_supervisor"] = function(Opal) {
  ...
  Opal.add_stubs(['$new', '$always_log', '$calculate_strategy']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$tick!', TMP_StrategySupervisor_tick$B_2 = function() {
      ...
      Opal.const_get_relative($nesting, 'Debug').$always_log("StrategySupervisor Tick!");
      self.$calculate_strategy();
      return Opal.const_get_relative($nesting, 'Debug').$always_log("StrategySupervisor Tock!");
    }, TMP_StrategySupervisor_tick$B_2.$$arity = 0);
    
    Opal.defn(self, '$initialize', TMP_StrategySupervisor_initialize_3 = function $$initialize() {
      var self = this;

      return (Opal.class_variable_set($StrategySupervisor, '@@strategy', "build"))
    ...
    Opal.defn(self, '$calculate_strategy', TMP_StrategySupervisor_calculate_strategy_4 = function $$calculate_strategy() {
      ...
      Opal.const_get_relative($nesting, 'Debug').$always_log("Calculating Strategy...");
      return Opal.const_get_relative($nesting, 'Debug').$always_log("" + "Strategy Calculated: " + ((($a = $StrategySupervisor.$$cvars['@@strategy']) == null ? nil : $a)));
...
Opal.modules["war_supervisor"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$new', '$always_log', '$tick!', '$shared']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_WarSupervisor_initialize_1, TMP_WarSupervisor_shared_2, TMP_WarSupervisor_tick$B_3;
    ...
    Opal.defs(self, '$shared', TMP_WarSupervisor_shared_2 = function $$shared() {
      ...
      return (Opal.class_variable_set($WarSupervisor, '@@supervisor', ($truthy($a = (($b = $WarSupervisor.$$cvars['@@supervisor']) == null ? nil : $b)) ? $a : self.$new())))
    }, TMP_WarSupervisor_shared_2.$$arity = 0);
    return (Opal.defn(self, '$tick!', TMP_WarSupervisor_tick$B_3 = function() {
      var self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$always_log("WarSupervisor Tick!");
      Opal.const_get_relative($nesting, 'StrategySupervisor').$shared()['$tick!']();
      return Opal.const_get_relative($nesting, 'Debug').$always_log("WarSupervisor Tock!");
    }, TMP_WarSupervisor_tick$B_3.$$arity = 0), nil) && 'tick!';
  })($nesting[0], null, $nesting);
};
