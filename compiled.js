...
/* Generated by Opal 0.11.4 */
Opal.modules["debug"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  function $rb_times(lhs, rhs) {
  ...
  Opal.add_stubs(['$!', '$puts', '$debugging', '$strftime', '$now', '$+', '$*']);
  return (function($base, $super, $parent_nesting) {
    function $Debug(){};
    var self = $Debug = $klass($base, $super, 'Debug', $Debug);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Debug_toggle_quiet_1, TMP_Debug_toggle_tasks_2, TMP_Debug_print_tasks_3, TMP_Debug_toggle_4, TMP_Debug_debugging_5, TMP_Debug_debug_6, TMP_Debug_always_log_7, TMP_Debug_separator_8;

    
    Opal.defs(self, '$toggle_quiet', TMP_Debug_toggle_quiet_1 = function $$toggle_quiet() {
      var $a, self = this;

      
      (Opal.class_variable_set($Debug, '@@quiet', (($a = $Debug.$$cvars['@@quiet']) == null ? nil : $a)['$!']()));
      return self.$puts("" + "Quiet Mode " + ((function() {if ($truthy((($a = $Debug.$$cvars['@@quiet']) == null ? nil : $a))) {
        return "Activated"
        } else {
        return "Deactivated"
      }; return nil; })()));
    }, TMP_Debug_toggle_quiet_1.$$arity = 0);
    Opal.defs(self, '$toggle_tasks', TMP_Debug_toggle_tasks_2 = function $$toggle_tasks() {
      var $a, self = this;

      
      (Opal.class_variable_set($Debug, '@@tasks', (($a = $Debug.$$cvars['@@tasks']) == null ? nil : $a)['$!']()));
      return self.$puts("" + "Tasks Mode " + ((function() {if ($truthy((($a = $Debug.$$cvars['@@tasks']) == null ? nil : $a))) {
        return "Activated"
        } else {
        return "Deactivated"
      }; return nil; })()));
    }, TMP_Debug_toggle_tasks_2.$$arity = 0);
    Opal.defs(self, '$print_tasks', TMP_Debug_print_tasks_3 = function $$print_tasks() {
      var $a, self = this;

      return (($a = $Debug.$$cvars['@@tasks']) == null ? nil : $a)
    }, TMP_Debug_print_tasks_3.$$arity = 0);
    Opal.defs(self, '$toggle', TMP_Debug_toggle_4 = function $$toggle() {
      var $a, self = this;

      
      (Opal.class_variable_set($Debug, '@@debugging', (($a = $Debug.$$cvars['@@debugging']) == null ? nil : $a)['$!']()));
      return self.$puts("" + "Debug Mode " + ((function() {if ($truthy((($a = $Debug.$$cvars['@@debugging']) == null ? nil : $a))) {
        return "Activated"
        } else {
        return "Deactivated"
      }; return nil; })()));
    }, TMP_Debug_toggle_4.$$arity = 0);
    Opal.defs(self, '$debugging', TMP_Debug_debugging_5 = function $$debugging() {
      var $a, $b, self = this;

      return ($truthy($a = (($b = $Debug.$$cvars['@@debugging']) == null ? nil : $b)) ? $a : false)
    }, TMP_Debug_debugging_5.$$arity = 0);
    Opal.defs(self, '$debug', TMP_Debug_debug_6 = function $$debug(msg) {
      var $a, $b, self = this;

      if ($truthy(($truthy($a = self.$debugging()) ? (($b = $Debug.$$cvars['@@quiet']) == null ? nil : $b)['$!']() : $a))) {
        return self.$puts("" + "(DEBUG) " + (Opal.const_get_relative($nesting, 'Time').$now().$strftime("%H:%M:%S")) + " | " + (msg))
        } else {
        return nil
      }
    }, TMP_Debug_debug_6.$$arity = 1);
    Opal.defs(self, '$always_log', TMP_Debug_always_log_7 = function $$always_log(msg) {
      var $a, self = this;

      if ($truthy((($a = $Debug.$$cvars['@@quiet']) == null ? nil : $a))) {
        return nil
        } else {
        return self.$puts("" + (Opal.const_get_relative($nesting, 'Time').$now().$strftime("%H:%M:%S")) + " | " + (msg))
      }
    }, TMP_Debug_always_log_7.$$arity = 1);
    return Opal.defs(self, '$separator', TMP_Debug_separator_8 = function $$separator(msg) {
      var $a, self = this;

      if ($truthy((($a = $Debug.$$cvars['@@quiet']) == null ? nil : $a))) {
        return nil
        } else {
        return self.$puts($rb_plus($rb_plus($rb_times("*", 10), "" + "(DEBUG: " + (Opal.const_get_relative($nesting, 'Debug').$debugging()) + " | " + (Opal.const_get_relative($nesting, 'Time').$now().$strftime("%H:%M:%S")) + ") " + (msg)), $rb_times("*", 10)))
      }
    }, TMP_Debug_separator_8.$$arity = 1);
  })($nesting[0], null, $nesting)
};
...
/* Generated by Opal 0.11.4 */
Opal.modules["globals"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;
  ...
  Opal.const_set($nesting[0], 'FIND_MY_CREEPS', self.$Native(FIND_MY_CREEPS));
  Opal.const_set($nesting[0], 'FIND_EXIT_TOP', self.$Native(FIND_EXIT_TOP));
  Opal.const_set($nesting[0], 'FIND_EXIT_RIGHT', self.$Native(FIND_EXIT_RIGHT));
  Opal.const_set($nesting[0], 'FIND_EXIT_BOTTOM', self.$Native(FIND_EXIT_BOTTOM));
  Opal.const_set($nesting[0], 'FIND_EXIT_LEFT', self.$Native(FIND_EXIT_LEFT));
  return Opal.const_set($nesting[0], 'FIND_EXIT', [self.$Native(FIND_EXIT), Opal.const_set($nesting[0], 'FIND_CREEPS', self.$Native(FIND_CREEPS)), Opal.const_set($nesting[0], 'FIND_MY_CREEPS', self.$Native(FIND_MY_CREEPS)), Opal.const_set($nesting[0], 'FIND_HOSTILE_CREEPS', self.$Native(FIND_HOSTILE_CREEPS)), Opal.const_set($nesting[0], 'FIND_SOURCES_ACTIVE', self.$Native(FIND_SOURCES_ACTIVE)), Opal.const_set($nesting[0], 'FIND_SOURCES', self.$Native(FIND_SOURCES)), Opal.const_set($nesting[0], 'FIND_DROPPED_ENERGY', self.$Native(FIND_DROPPED_ENERGY)), Opal.const_set($nesting[0], 'FIND_DROPPED_RESOURCES', self.$Native(FIND_DROPPED_RESOURCES)), Opal.const_set($nesting[0], 'FIND_STRUCTURES', self.$Native(FIND_STRUCTURES)), Opal.const_set($nesting[0], 'FIND_MY_STRUCTURES', self.$Native(FIND_MY_STRUCTURES)), Opal.const_set($nesting[0], 'FIND_HOSTILE_STRUCTURES', self.$Native(FIND_HOSTILE_STRUCTURES)), Opal.const_set($nesting[0], 'FIND_FLAGS', self.$Native(FIND_FLAGS)), Opal.const_set($nesting[0], 'FIND_CONSTRUCTION_SITES', self.$Native(FIND_CONSTRUCTION_SITES)), Opal.const_set($nesting[0], 'FIND_MY_SPAWNS', self.$Native(FIND_MY_SPAWNS)), Opal.const_set($nesting[0], 'FIND_HOSTILE_SPAWNS', self.$Native(FIND_HOSTILE_SPAWNS)), Opal.const_set($nesting[0], 'FIND_MY_CONSTRUCTION_SITES', self.$Native(FIND_MY_CONSTRUCTION_SITES)), Opal.const_set($nesting[0], 'FIND_HOSTILE_CONSTRUCTION_SITES', self.$Native(FIND_HOSTILE_CONSTRUCTION_SITES)), Opal.const_set($nesting[0], 'FIND_MINERALS', self.$Native(FIND_MINERALS)), Opal.const_set($nesting[0], 'FIND_NUKES', self.$Native(FIND_NUKES)), Opal.const_set($nesting[0], 'FIND_TOMBSTONES', self.$Native(FIND_TOMBSTONES))]);
};

/* Generated by Opal 0.11.4 */
Opal.modules["creep"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy;

  Opal.add_stubs(['$attr_accessor', '$creep_name=', '$-', '$current_task=', '$refresh', '$[]', '$Native', '$creep_name', '$creep_obj', '$name=', '$ttl=', '$hits=', '$hits_max=', '$fatigue=', '$map', '$body', '$to_s', '$debug', '$name', '$hits', '$hits_max', '$ttl', '$fatigue']);
  return (function($base, $super, $parent_nesting) {
    function $Creep(){};
    var self = $Creep = $klass($base, $super, 'Creep', $Creep);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Creep_initialize_1, TMP_Creep_creep_obj_2, TMP_Creep_refresh_3, TMP_Creep_body_parts_5, TMP_Creep_tick$B_6, TMP_Creep_to_s_7;

    def.body_parts = nil;
    
    self.$attr_accessor("creep_name", "name", "ttl", "hits", "hits_max", "fatigue", "current_task", "body_parts");
    
    Opal.defn(self, '$initialize', TMP_Creep_initialize_1 = function $$initialize(name) {
      var self = this, $writer = nil;

      
      
      $writer = [name];
      $send(self, 'creep_name=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [nil];
      $send(self, 'current_task=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      return self.$refresh();
    }, TMP_Creep_initialize_1.$$arity = 1);
    ...
    Opal.defn(self, '$refresh', TMP_Creep_refresh_3 = function $$refresh() {
      ...
      $writer = [self.$creep_obj()['$[]']("name")];
      $send(self, 'name=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [self.$creep_obj()['$[]']("ticksToLive")];
      $send(self, 'ttl=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [self.$creep_obj()['$[]']("hits")];
      $send(self, 'hits=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [self.$creep_obj()['$[]']("hitsMax")];
      $send(self, 'hits_max=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [self.$creep_obj()['$[]']("fatigue")];
      $send(self, 'fatigue=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];;
    }, TMP_Creep_refresh_3.$$arity = 0);
    
    Opal.defn(self, '$body_parts', TMP_Creep_body_parts_5 = function $$body_parts() {
      var $a, TMP_4, self = this;

      
      self.body_parts = ($truthy($a = self.body_parts) ? $a : $send(self.$creep_obj().$body(), 'map', [], (TMP_4 = function(part){var self = TMP_4.$$s || this;
if (part == null) part = nil;
      return part['$[]']("type").$to_s()}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4)));
      return self.body_parts;
    }, TMP_Creep_body_parts_5.$$arity = 0);
    
    Opal.defn(self, '$tick!', TMP_Creep_tick$B_6 = function() {
      var self = this;

      
      self.$refresh();
      Opal.const_get_relative($nesting, 'Debug').$debug("" + "Creep " + (self.$name()) + " tick!");
      Opal.const_get_relative($nesting, 'Debug').$debug(self);
      return Opal.const_get_relative($nesting, 'Debug').$debug("" + "Creep " + (self.$name()) + " tock!");
    }, TMP_Creep_tick$B_6.$$arity = 0);
    return (Opal.defn(self, '$to_s', TMP_Creep_to_s_7 = function $$to_s() {
      var self = this;

      
      try {
        return "" + "Game.creeps['" + (self.$name()) + "']: " + (self.$hits()) + "/" + (self.$hits_max()) + "HP | " + (self.$ttl()) + " TTL | " + (self.$fatigue()) + " FAT"
      } catch ($err) {
        if (Opal.rescue($err, [Opal.const_get_relative($nesting, 'StandardError')])) {
          try {
            return nil
    ...
    }, TMP_Creep_to_s_7.$$arity = 0), nil) && 'to_s';
  })($nesting[0], null, $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["strategy"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$attr_accessor']);
  return (function($base, $super, $parent_nesting) {
    function $Strategy(){};
    var self = $Strategy = $klass($base, $super, 'Strategy', $Strategy);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Strategy_requirements_1;

    
    self.$attr_accessor("name");
    return Opal.defs(self, '$requirements', TMP_Strategy_requirements_1 = function $$requirements() {
      var self = this;

      return $hash2(["miner", "builder", "supplier", "upgrader", "healer"], {"miner": 0, "builder": 0, "supplier": 0, "upgrader": 0, "healer": 0})
    }, TMP_Strategy_requirements_1.$$arity = 0);
  })($nesting[0], null, $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["task_manager"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  function $rb_ge(lhs, rhs) {
  ...
  Opal.add_stubs(['$attr_accessor', '$new', '$tasks=', '$-', '$debug', '$select', '$tasks', '$==', '$name', '$length', '$>=', '$<', '$<<', '$each', '$assigned_id', '$completed', '$execute', '$print_tasks', '$always_log']);
  return (function($base, $super, $parent_nesting) {
    function $TaskManager(){};
    var self = $TaskManager = $klass($base, $super, 'TaskManager', $TaskManager);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_TaskManager_shared_1, TMP_TaskManager_initialize_2, TMP_TaskManager_add_task_4, TMP_TaskManager_tick$B_6, TMP_TaskManager_print_tasks_8;

    
    self.$attr_accessor("tasks");
    Opal.defs(self, '$shared', TMP_TaskManager_shared_1 = function $$shared() {
      var $a, $b, self = this;

      return (Opal.class_variable_set($TaskManager, '@@manager', ($truthy($a = (($b = $TaskManager.$$cvars['@@manager']) == null ? nil : $b)) ? $a : self.$new())))
    }, TMP_TaskManager_shared_1.$$arity = 0);
    
    Opal.defn(self, '$initialize', TMP_TaskManager_initialize_2 = function $$initialize() {
      var self = this, $writer = nil;

      
      $writer = [[]];
      $send(self, 'tasks=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_TaskManager_initialize_2.$$arity = 0);
    
    Opal.defn(self, '$add_task', TMP_TaskManager_add_task_4 = function $$add_task(task, duplicates_allowed) {
      var $a, TMP_3, self = this, desired_tasks = nil;

      if (duplicates_allowed == null) {
        duplicates_allowed = 1;
      }
      
      Opal.const_get_relative($nesting, 'Debug').$debug("" + "TaskManager: Adding task: " + (task));
      desired_tasks = ($truthy($a = $send(self.$tasks(), 'select', [], (TMP_3 = function(t){var self = TMP_3.$$s || this;
if (t == null) t = nil;
      return t.$name()['$=='](task.$name())}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3))) ? $a : []);
      Opal.const_get_relative($nesting, 'Debug').$debug("" + "desired_tasks: " + (desired_tasks.$length()) + " | duplicates_allowed: " + (duplicates_allowed));
      if ($truthy(($truthy($a = $rb_ge(duplicates_allowed, 1)) ? $rb_lt(desired_tasks.$length(), duplicates_allowed) : $a))) {
        return self.$tasks()['$<<'](task)
        } else {
        return nil
      };
    }, TMP_TaskManager_add_task_4.$$arity = -2);
    
    Opal.defn(self, '$tick!', TMP_TaskManager_tick$B_6 = function() {
      var TMP_5, self = this;

      return $send(self.$tasks(), 'each', [], (TMP_5 = function(task){var self = TMP_5.$$s || this, $a;
if (task == null) task = nil;
      if ($truthy(($truthy($a = task.$assigned_id()) ? $a : task.$completed()))) {
          return nil
          } else {
          return task.$execute()
        }}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5))
    }, TMP_TaskManager_tick$B_6.$$arity = 0);
    return (Opal.defn(self, '$print_tasks', TMP_TaskManager_print_tasks_8 = function $$print_tasks() {
      var TMP_7, self = this;

      if ($truthy(Opal.const_get_relative($nesting, 'Debug').$print_tasks())) {
        
        Opal.const_get_relative($nesting, 'Debug').$always_log("" + "Task Count: " + (self.$tasks().$length()));
        return $send(self.$tasks(), 'each', [], (TMP_7 = function(t){var self = TMP_7.$$s || this;
if (t == null) t = nil;
        return Opal.const_get_relative($nesting, 'Debug').$always_log(t)}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7));
        } else {
        return nil
      }
    }, TMP_TaskManager_print_tasks_8.$$arity = 0), nil) && 'print_tasks';
  })($nesting[0], null, $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["task"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send;

  Opal.add_stubs(['$attr_accessor', '$debug', '$name=', '$-', '$data=', '$completed=', '$completed', '$!', '$nil?', '$assigned_id', '$to_s', '$class', '$name', '$data']);
  return (function($base, $super, $parent_nesting) {
    function $Task(){};
    var self = $Task = $klass($base, $super, 'Task', $Task);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Task_get_owner_1, TMP_Task_find_available_candidates_2, TMP_Task_initialize_3, TMP_Task_execute_4, TMP_Task_to_s_5;

    
    self.$attr_accessor("assigned_id", "name", "data", "completed");
    
    Opal.defn(self, '$get_owner', TMP_Task_get_owner_1 = function $$get_owner() {
      var self = this;

      return Opal.const_get_relative($nesting, 'Debug').$debug("Attempted to execute get_owner without overriding the base clase")
    }, TMP_Task_get_owner_1.$$arity = 0);
    
    Opal.defn(self, '$find_available_candidates', TMP_Task_find_available_candidates_2 = function $$find_available_candidates() {
      var self = this;

      return Opal.const_get_relative($nesting, 'Debug').$debug("Attempted to execute find_available_candidates without overriding base class")
    }, TMP_Task_find_available_candidates_2.$$arity = 0);
    
    Opal.defn(self, '$initialize', TMP_Task_initialize_3 = function $$initialize(name, data) {
      var self = this, $writer = nil;
      ...
      $writer = [false];
      $send(self, 'completed=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];;
    }, TMP_Task_initialize_3.$$arity = 2);
    
    Opal.defn(self, '$execute', TMP_Task_execute_4 = function $$execute() {
      var self = this;

      return Opal.const_get_relative($nesting, 'Debug').$debug("Attempted to execute a task that has not been defined.")
    }, TMP_Task_execute_4.$$arity = 0);
    return (Opal.defn(self, '$to_s', TMP_Task_to_s_5 = function $$to_s() {
      var self = this;

      return "" + "Completed? " + (self.$completed()) + " | Owned? " + (self.$assigned_id()['$nil?']()['$!']()) + " | " + (self.$class().$to_s()) + ": " + (self.$name()) + " | Data: " + (self.$data())
    }, TMP_Task_to_s_5.$$arity = 0), nil) && 'to_s';
  })($nesting[0], null, $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["tasks/spawn_task"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$debug']);
  
  self.$require("task");
  return (function($base, $super, $parent_nesting) {
    function $SpawnTask(){};
    var self = $SpawnTask = $klass($base, $super, 'SpawnTask', $SpawnTask);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_SpawnTask_execute_1, TMP_SpawnTask_find_owner_2;

    
    
    Opal.defn(self, '$execute', TMP_SpawnTask_execute_1 = function $$execute(owner) {
      var self = this;

      return Opal.const_get_relative($nesting, 'Debug').$debug("Executing Spawn Task")
    }, TMP_SpawnTask_execute_1.$$arity = 1);
    return (Opal.defn(self, '$find_owner', TMP_SpawnTask_find_owner_2 = function $$find_owner() {
      var self = this;

      return nil
    }, TMP_SpawnTask_find_owner_2.$$arity = 0), nil) && 'find_owner';
  })($nesting[0], Opal.const_get_relative($nesting, 'Task'), $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["strategies/begin_strategy"] = function(Opal) {
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  function $rb_lt(lhs, rhs) {
  ...
  Opal.add_stubs(['$require', '$debug', '$requirements', '$==', '$new', '$add_task', '$shared', '$each_pair', '$nil?', '$[]', '$>', '$<', '$length', '$create_spawn_task']);
  
  self.$require("strategy");
  self.$require("task_manager");
  self.$require("tasks/spawn_task");
  return (function($base, $super, $parent_nesting) {
    function $BeginStrategy(){};
    var self = $BeginStrategy = $klass($base, $super, 'BeginStrategy', $BeginStrategy);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_BeginStrategy_requirements_1, TMP_BeginStrategy_generate_tasks_3, TMP_BeginStrategy_create_spawn_task_4;

    
    Opal.defs(self, '$requirements', TMP_BeginStrategy_requirements_1 = function $$requirements() {
      var self = this;

      return $hash2(["miner", "builder", "supplier", "upgrader", "healer"], {"miner": 5, "builder": 0, "supplier": 0, "upgrader": 0, "healer": 0})
    }, TMP_BeginStrategy_requirements_1.$$arity = 0);
    Opal.defs(self, '$generate_tasks', TMP_BeginStrategy_generate_tasks_3 = function $$generate_tasks(capabilities) {
      var TMP_2, self = this, task = nil;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("BeginStrat: Generating Tasks.");
      Opal.const_get_relative($nesting, 'Debug').$debug("Capabilities: ");
      Opal.const_get_relative($nesting, 'Debug').$debug(capabilities);
      Opal.const_get_relative($nesting, 'Debug').$debug("Requirements: ");
      Opal.const_get_relative($nesting, 'Debug').$debug(self.$requirements());
      if (capabilities['$==']($hash2([], {}))) {
        
        Opal.const_get_relative($nesting, 'Debug').$debug("Bootstrapper Needed!");
        task = Opal.const_get_relative($nesting, 'SpawnTask').$new("bootstrapper", $hash2(["parts", "prefix"], {"parts": [Opal.const_get_relative($nesting, 'WORK'), Opal.const_get_relative($nesting, 'CARRY'), Opal.const_get_relative($nesting, 'MOVE')], "prefix": "bootstrapper"}));
        Opal.const_get_relative($nesting, 'TaskManager').$shared().$add_task(task, 1);};
      return $send(self.$requirements(), 'each_pair', [], (TMP_2 = function(role, count){var self = TMP_2.$$s || this, $a, capabilities_for_role = nil;
if (role == null) role = nil;if (count == null) count = nil;
      
        capabilities_for_role = (function() {if ($truthy(capabilities['$[]'](role)['$nil?']())) {
          return []
          } else {
          return capabilities['$[]'](role)
        }; return nil; })();
        if ($truthy(($truthy($a = $rb_gt(count, 0)) ? $rb_lt(capabilities_for_role.$length(), count) : $a))) {
          
          Opal.const_get_relative($nesting, 'Debug').$debug("" + "count: " + (count) + " | role: " + (role) + " | capabilities[role]: " + (capabilities_for_role.$length()));
          Opal.const_get_relative($nesting, 'Debug').$debug("" + "Creating Task to Spawn: " + (role));
          return self.$create_spawn_task(role, count);
          } else {
          return nil
        };}, TMP_2.$$s = self, TMP_2.$$arity = 2, TMP_2));
    }, TMP_BeginStrategy_generate_tasks_3.$$arity = 1);
    return Opal.defs(self, '$create_spawn_task', TMP_BeginStrategy_create_spawn_task_4 = function $$create_spawn_task(role, count) {
      var self = this, task = nil;

      
      task = Opal.const_get_relative($nesting, 'SpawnTask').$new(role, $hash2(["parts", "prefix"], {"parts": [Opal.const_get_relative($nesting, 'WORK'), Opal.const_get_relative($nesting, 'CARRY'), Opal.const_get_relative($nesting, 'MOVE')], "prefix": "miner"}));
      return Opal.const_get_relative($nesting, 'TaskManager').$shared().$add_task(task, count);
    }, TMP_BeginStrategy_create_spawn_task_4.$$arity = 2);
  })($nesting[0], Opal.const_get_relative($nesting, 'Strategy'), $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["population_controller"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2, $send = Opal.send, $truthy = Opal.truthy;

  Opal.add_stubs(['$require', '$attr_accessor', '$capability_breakdown=', '$-', '$creeps_by_parts=', '$room=', '$refresh', '$debug', '$generate_tasks', '$strategy', '$shared', '$===', '$capability_breakdown', '$analyze_capabilities', '$each', '$creeps', '$room', '$body_parts', '$creeps_by_parts', '$[]', '$[]=', '$<<', '$name', '$analyze_creep', '$creep_name', '$include?']);
  
  self.$require("strategies/begin_strategy");
  return (function($base, $super, $parent_nesting) {
    function $PopulationController(){};
    var self = $PopulationController = $klass($base, $super, 'PopulationController', $PopulationController);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_PopulationController_initialize_1, TMP_PopulationController_tick$B_2, TMP_PopulationController_generate_tasks_3, TMP_PopulationController_refresh_4, TMP_PopulationController_analyze_capabilities_8, TMP_PopulationController_analyze_creep_9, TMP_PopulationController_print_creeps_by_parts_10, TMP_PopulationController_print_capabilities_11;

    
    self.$attr_accessor("room", "creeps_by_parts", "capability_breakdown");
    
    Opal.defn(self, '$initialize', TMP_PopulationController_initialize_1 = function $$initialize(room) {
      var self = this, $writer = nil;

      
      
      $writer = [$hash2([], {})];
      $send(self, 'capability_breakdown=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [$hash2([], {})];
      $send(self, 'creeps_by_parts=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [room];
      $send(self, 'room=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      return self.$refresh();
    }, TMP_PopulationController_initialize_1.$$arity = 1);
    
    Opal.defn(self, '$tick!', TMP_PopulationController_tick$B_2 = function() {
      var self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("PopulationController Tick!");
      self.$refresh();
      self.$generate_tasks();
      return Opal.const_get_relative($nesting, 'Debug').$debug("PopulationController Tock!");
    }, TMP_PopulationController_tick$B_2.$$arity = 0);
    
    Opal.defn(self, '$generate_tasks', TMP_PopulationController_generate_tasks_3 = function $$generate_tasks() {
      var self = this, $case = nil;

      return (function() {$case = Opal.const_get_relative($nesting, 'StrategySupervisor').$shared().$strategy();
      if ("begin"['$===']($case)) {
      Opal.const_get_relative($nesting, 'Debug').$debug("Executing Begin Strategy");
      return Opal.const_get_relative($nesting, 'BeginStrategy').$generate_tasks(self.$capability_breakdown());}
      else { return nil }})()
    }, TMP_PopulationController_generate_tasks_3.$$arity = 0);
    
    Opal.defn(self, '$refresh', TMP_PopulationController_refresh_4 = function $$refresh() {
      var self = this;

      return self.$analyze_capabilities()
    }, TMP_PopulationController_refresh_4.$$arity = 0);
    
    Opal.defn(self, '$analyze_capabilities', TMP_PopulationController_analyze_capabilities_8 = function $$analyze_capabilities() {
      var TMP_5, self = this, $writer = nil;
      ...
      $send(self, 'capability_breakdown=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      return $send(self.$room().$creeps(), 'each', [], (TMP_5 = function(creep){var self = TMP_5.$$s || this, TMP_6, TMP_7, creep_roles = nil;
if (creep == null) creep = nil;
      
        $send(creep.$body_parts(), 'each', [], (TMP_6 = function(part){var self = TMP_6.$$s || this, $a, $logical_op_recvr_tmp_1 = nil;
if (part == null) part = nil;
        
          
          $logical_op_recvr_tmp_1 = self.$creeps_by_parts();
          ($truthy($a = $logical_op_recvr_tmp_1['$[]'](part)) ? $a : (($writer = [part, []]), $send($logical_op_recvr_tmp_1, '[]=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]));;
          return self.$creeps_by_parts()['$[]'](part)['$<<'](creep.$name());}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6));
        creep_roles = self.$analyze_creep(creep);
        return $send(creep_roles, 'each', [], (TMP_7 = function(role){var self = TMP_7.$$s || this, $a, $logical_op_recvr_tmp_2 = nil;
if (role == null) role = nil;
        
          
          $logical_op_recvr_tmp_2 = self.$capability_breakdown();
          ($truthy($a = $logical_op_recvr_tmp_2['$[]'](role)) ? $a : (($writer = [role, []]), $send($logical_op_recvr_tmp_2, '[]=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]));;
          return self.$capability_breakdown()['$[]'](role)['$<<'](creep.$creep_name());}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7));}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5));
    }, TMP_PopulationController_analyze_capabilities_8.$$arity = 0);
    
    Opal.defn(self, '$analyze_creep', TMP_PopulationController_analyze_creep_9 = function $$analyze_creep(creep) {
      var $a, $b, self = this, roles = nil;

      
      roles = [];
      if ($truthy(($truthy($a = ($truthy($b = creep.$body_parts()['$include?']("work")) ? creep.$body_parts()['$include?']("carry") : $b)) ? creep.$body_parts()['$include?']("move") : $a))) {
        roles['$<<']("miner")};
      return roles;
    }, TMP_PopulationController_analyze_creep_9.$$arity = 1);
    
    Opal.defn(self, '$print_creeps_by_parts', TMP_PopulationController_print_creeps_by_parts_10 = function $$print_creeps_by_parts() {
      var self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("Printing creeps by part:");
      return Opal.const_get_relative($nesting, 'Debug').$debug(self.$creeps_by_parts());
    }, TMP_PopulationController_print_creeps_by_parts_10.$$arity = 0);
    return (Opal.defn(self, '$print_capabilities', TMP_PopulationController_print_capabilities_11 = function $$print_capabilities() {
      var self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("Printing Capabilities:");
      return Opal.const_get_relative($nesting, 'Debug').$debug(self.$capability_breakdown());
    }, TMP_PopulationController_print_capabilities_11.$$arity = 0), nil) && 'print_capabilities';
  })($nesting[0], null, $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["room"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send;

  Opal.add_stubs(['$require', '$attr_accessor', '$name=', '$-', '$creeps=', '$spawns=', '$strategy=', '$energy_available=', '$energy_capacity_available=', '$new', '$population_controller=', '$refresh', '$debug', '$name', '$each', '$find', '$room_obj', '$<<', '$creeps', '$[]', '$spawns', '$Native', '$tick!', '$population_controller']);
  
  self.$require("creep");
  self.$require("population_controller");
  return (function($base, $super, $parent_nesting) {
    function $Room(){};
    var self = $Room = $klass($base, $super, 'Room', $Room);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Room_initialize_1, TMP_Room_refresh_4, TMP_Room_room_obj_5, TMP_Room_tick$B_7, TMP_Room_get_room_by_name_8;

    
    self.$attr_accessor("name", "creeps", "strategy", "energy_available", "energy_capacity_available", "spawns", "threat_level");
    self.$attr_accessor("population_controller", "resource_supervisor");
    
    Opal.defn(self, '$initialize', TMP_Room_initialize_1 = function $$initialize(name) {
      var self = this, $writer = nil;
      ...
      $writer = [[]];
      $send(self, 'creeps=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [[]];
      $send(self, 'spawns=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [nil];
      $send(self, 'strategy=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [0];
      $send(self, 'energy_available=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [0];
      $send(self, 'energy_capacity_available=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [Opal.const_get_relative($nesting, 'PopulationController').$new(self)];
      $send(self, 'population_controller=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      self.$refresh();
      return Opal.const_get_relative($nesting, 'Debug').$debug("" + "Loaded Room " + (self.$name()));
    }, TMP_Room_initialize_1.$$arity = 1);
    
    Opal.defn(self, '$refresh', TMP_Room_refresh_4 = function $$refresh() {
      var TMP_2, TMP_3, self = this, $writer = nil;
      ...
      $send(self, 'spawns=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      $send(self.$room_obj().$find(Opal.const_get_relative($nesting, 'FIND_MY_CREEPS')), 'each', [], (TMP_2 = function(creep_obj){var self = TMP_2.$$s || this;
if (creep_obj == null) creep_obj = nil;
      return self.$creeps()['$<<'](Opal.const_get_relative($nesting, 'Creep').$new(creep_obj['$[]']("name")))}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2));
      $send(self.$room_obj().$find(Opal.const_get_relative($nesting, 'FIND_MY_SPAWNS')), 'each', [], (TMP_3 = function(spawn_obj){var self = TMP_3.$$s || this;
if (spawn_obj == null) spawn_obj = nil;
      return self.$spawns()['$<<'](spawn_obj['$[]']("name"))}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3));
      
      $writer = [self.$room_obj()['$[]']("energyAvailable")];
      $send(self, 'energy_available=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [self.$room_obj()['$[]']("energyCapacityAvailable")];
      $send(self, 'energy_capacity_available=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];;
    }, TMP_Room_refresh_4.$$arity = 0);
    
    Opal.defn(self, '$room_obj', TMP_Room_room_obj_5 = function $$room_obj() {
      var self = this;

      return self.$Native(Game)['$[]']("rooms")['$[]'](self.$name())
    }, TMP_Room_room_obj_5.$$arity = 0);
    
    Opal.defn(self, '$tick!', TMP_Room_tick$B_7 = function() {
      var TMP_6, self = this;

      
      self.$refresh();
      Opal.const_get_relative($nesting, 'Debug').$debug("" + "Room " + (self.$name()) + " tick!");
      self.$population_controller()['$tick!']();
      $send(self.$creeps(), 'each', [], (TMP_6 = function(creep){var self = TMP_6.$$s || this;
if (creep == null) creep = nil;
      return creep['$tick!']()}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6));
      return Opal.const_get_relative($nesting, 'Debug').$debug("" + "Room " + (self.$name()) + " tock!");
    }, TMP_Room_tick$B_7.$$arity = 0);
    return Opal.defs(self, '$get_room_by_name', TMP_Room_get_room_by_name_8 = function $$get_room_by_name(name) {
      var self = this;

      return self.$Native(Game)['$[]']("rooms")['$[]'](name)
    }, TMP_Room_get_room_by_name_8.$$arity = 1);
  })($nesting[0], null, $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["strategy_supervisor"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $truthy = Opal.truthy, $send = Opal.send;

  Opal.add_stubs(['$require', '$attr_accessor', '$new', '$debug', '$calculate_strategy', '$strategy=', '$-', '$puts', '$name', '$to_s', '$strategy', '$energy_available', '$energy_capacity_available', '$length', '$spawns', '$creeps', '$each', '$rooms', '$shared', '$calculate_strategy_for_room']);
  
  self.$require("room");
  return (function($base, $super, $parent_nesting) {
    function $StrategySupervisor(){};
    var self = $StrategySupervisor = $klass($base, $super, 'StrategySupervisor', $StrategySupervisor);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_StrategySupervisor_shared_1, TMP_StrategySupervisor_tick$B_2, TMP_StrategySupervisor_initialize_3, TMP_StrategySupervisor_calculate_strategy_for_room_4, TMP_StrategySupervisor_calculate_strategy_6, TMP_StrategySupervisor_strategy_7;

    
    self.$attr_accessor("strategy");
    Opal.defs(self, '$shared', TMP_StrategySupervisor_shared_1 = function $$shared() {
      var $a, $b, self = this;

      
      (Opal.class_variable_set($StrategySupervisor, '@@supervisor', ($truthy($a = (($b = $StrategySupervisor.$$cvars['@@supervisor']) == null ? nil : $b)) ? $a : self.$new())));
      return (($a = $StrategySupervisor.$$cvars['@@supervisor']) == null ? nil : $a);
    }, TMP_StrategySupervisor_shared_1.$$arity = 0);
    
    Opal.defn(self, '$tick!', TMP_StrategySupervisor_tick$B_2 = function() {
      var self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("StrategySupervisor Tick!");
      self.$calculate_strategy();
      return Opal.const_get_relative($nesting, 'Debug').$debug("StrategySupervisor Tock!");
    }, TMP_StrategySupervisor_tick$B_2.$$arity = 0);
    
    Opal.defn(self, '$initialize', TMP_StrategySupervisor_initialize_3 = function $$initialize() {
      var self = this, $writer = nil;
      ...
      $send(self, 'strategy=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_StrategySupervisor_initialize_3.$$arity = 0);
    
    Opal.defn(self, '$calculate_strategy_for_room', TMP_StrategySupervisor_calculate_strategy_for_room_4 = function $$calculate_strategy_for_room(room) {
      var self = this, $writer = nil;

      
      self.$puts("" + "Calculating Strategy for Room " + (room.$name()));
      
      $writer = [Opal.const_get_relative($nesting, 'BeginStrategy')];
      $send(room, 'strategy=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      return self.$puts("" + "Room Info: " + (room.$name()) + " | Strategy: " + (room.$strategy().$to_s()) + " | " + (room.$energy_available()) + "/" + (room.$energy_capacity_available()) + " | " + (room.$spawns().$length()) + " spawns | " + (room.$creeps().$length()) + " creeps");
    }, TMP_StrategySupervisor_calculate_strategy_for_room_4.$$arity = 1);
    
    Opal.defn(self, '$calculate_strategy', TMP_StrategySupervisor_calculate_strategy_6 = function $$calculate_strategy() {
      var TMP_5, self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("Calculating Strategy...");
      $send(Opal.const_get_relative($nesting, 'RoomSupervisor').$shared().$rooms(), 'each', [], (TMP_5 = function(room){var self = TMP_5.$$s || this;
if (room == null) room = nil;
      return self.$calculate_strategy_for_room(room)}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5));
      return Opal.const_get_relative($nesting, 'Debug').$debug("" + "Strategy Calculated: " + (self.$strategy()));
    }, TMP_StrategySupervisor_calculate_strategy_6.$$arity = 0);
    return Opal.defs(self, '$strategy', TMP_StrategySupervisor_strategy_7 = function $$strategy() {
      var self = this;

      return self.$shared().$strategy()
    }, TMP_StrategySupervisor_strategy_7.$$arity = 0);
  })($nesting[0], null, $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["military_supervisor"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $truthy = Opal.truthy;

  Opal.add_stubs(['$attr_accessor', '$new', '$debug']);
  return (function($base, $super, $parent_nesting) {
    function $MilitarySupervisor(){};
    var self = $MilitarySupervisor = $klass($base, $super, 'MilitarySupervisor', $MilitarySupervisor);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MilitarySupervisor_initialize_1, TMP_MilitarySupervisor_shared_2, TMP_MilitarySupervisor_tick$B_3;

    
    self.$attr_accessor("war_supervisor");
    
    Opal.defn(self, '$initialize', TMP_MilitarySupervisor_initialize_1 = function $$initialize() {
      var self = this;

      return nil
    }, TMP_MilitarySupervisor_initialize_1.$$arity = 0);
    Opal.defs(self, '$shared', TMP_MilitarySupervisor_shared_2 = function $$shared() {
      var $a, $b, self = this;

      
      (Opal.class_variable_set($MilitarySupervisor, '@@supervisor', ($truthy($a = (($b = $MilitarySupervisor.$$cvars['@@supervisor']) == null ? nil : $b)) ? $a : self.$new())));
      return (($a = $MilitarySupervisor.$$cvars['@@supervisor']) == null ? nil : $a);
    }, TMP_MilitarySupervisor_shared_2.$$arity = 0);
    return (Opal.defn(self, '$tick!', TMP_MilitarySupervisor_tick$B_3 = function() {
      var self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("MilitarySupervisor Tick!");
      return Opal.const_get_relative($nesting, 'Debug').$debug("MilitarySupervisor Tock!");
    }, TMP_MilitarySupervisor_tick$B_3.$$arity = 0), nil) && 'tick!';
  })($nesting[0], null, $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["threat_assessor"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$debug', '$name']);
  return (function($base, $super, $parent_nesting) {
    function $ThreatAssessor(){};
    var self = $ThreatAssessor = $klass($base, $super, 'ThreatAssessor', $ThreatAssessor);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ThreatAssessor_assess_1;

    return Opal.defs(self, '$assess', TMP_ThreatAssessor_assess_1 = function $$assess(room) {
      var self = this, level = nil;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("" + "ThreatAssessor assessing threat level for " + (room.$name()) + "...");
      level = 0;
      Opal.const_get_relative($nesting, 'Debug').$debug("" + "ThreatAssessment: " + (level));
      return level;
    }, TMP_ThreatAssessor_assess_1.$$arity = 1)
  })($nesting[0], null, $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["room_supervisor"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy;

  Opal.add_stubs(['$require', '$attr_accessor', '$rooms=', '$-', '$refresh', '$new', '$debug', '$each', '$rooms', '$tick!', '$[]', '$Native', '$get_room_by_name', '$nil?', '$assess', '$threat_level=', '$<<']);
  
  self.$require("room");
  self.$require("threat_assessor");
  return (function($base, $super, $parent_nesting) {
    function $RoomSupervisor(){};
    var self = $RoomSupervisor = $klass($base, $super, 'RoomSupervisor', $RoomSupervisor);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_RoomSupervisor_initialize_1, TMP_RoomSupervisor_shared_2, TMP_RoomSupervisor_tick$B_4, TMP_RoomSupervisor_refresh_6;

    
    self.$attr_accessor("rooms");
    
    Opal.defn(self, '$initialize', TMP_RoomSupervisor_initialize_1 = function $$initialize() {
      var self = this, $writer = nil;
      ...
      $writer[$rb_minus($writer["length"], 1)];;
      return self.$refresh();
    }, TMP_RoomSupervisor_initialize_1.$$arity = 0);
    Opal.defs(self, '$shared', TMP_RoomSupervisor_shared_2 = function $$shared() {
      var $a, $b, self = this;

      
      (Opal.class_variable_set($RoomSupervisor, '@@supervisor', ($truthy($a = (($b = $RoomSupervisor.$$cvars['@@supervisor']) == null ? nil : $b)) ? $a : self.$new())));
      return (($a = $RoomSupervisor.$$cvars['@@supervisor']) == null ? nil : $a);
    }, TMP_RoomSupervisor_shared_2.$$arity = 0);
    
    Opal.defn(self, '$tick!', TMP_RoomSupervisor_tick$B_4 = function() {
      var TMP_3, self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("RoomSupervisor Tick!");
      self.$refresh();
      $send(self.$rooms(), 'each', [], (TMP_3 = function(room){var self = TMP_3.$$s || this;
if (room == null) room = nil;
      return room['$tick!']()}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3));
      return Opal.const_get_relative($nesting, 'Debug').$debug("RoomSupervisor Tock!");
    }, TMP_RoomSupervisor_tick$B_4.$$arity = 0);
    return (Opal.defn(self, '$refresh', TMP_RoomSupervisor_refresh_6 = function $$refresh() {
      var TMP_5, self = this, $writer = nil;
      ...
      $send(self, 'rooms=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      return $send(self.$Native(Game)['$[]']("rooms"), 'each', [], (TMP_5 = function(room_name){var self = TMP_5.$$s || this, room_obj = nil, new_room = nil;
if (room_name == null) room_name = nil;
      
        room_obj = Opal.const_get_relative($nesting, 'Room').$get_room_by_name(room_name);
        if ($truthy(room_obj['$[]']("controller")['$nil?']())) {
          return nil
          } else {
          
          new_room = Opal.const_get_relative($nesting, 'Room').$new(room_name);
          
          $writer = [Opal.const_get_relative($nesting, 'ThreatAssessor').$assess(new_room)];
          $send(new_room, 'threat_level=', Opal.to_a($writer));
          $writer[$rb_minus($writer["length"], 1)];;
          return self.$rooms()['$<<'](new_room);
        };}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5));
    }, TMP_RoomSupervisor_refresh_6.$$arity = 0), nil) && 'refresh';
  })($nesting[0], null, $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["war_supervisor"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy;

  Opal.add_stubs(['$require', '$attr_accessor', '$supervisors=', '$-', '$shared', '$military_supervisor=', '$room_supervisor=', '$<<', '$supervisors', '$room_supervisor', '$military_supervisor', '$new', '$debug', '$each', '$tick!']);
  
  self.$require("strategy_supervisor");
  self.$require("military_supervisor");
  self.$require("room_supervisor");
  return (function($base, $super, $parent_nesting) {
    function $WarSupervisor(){};
    var self = $WarSupervisor = $klass($base, $super, 'WarSupervisor', $WarSupervisor);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_WarSupervisor_initialize_1, TMP_WarSupervisor_shared_2, TMP_WarSupervisor_tick$B_4;

    
    self.$attr_accessor("supervisors", "military_supervisor", "room_supervisor");
    
    Opal.defn(self, '$initialize', TMP_WarSupervisor_initialize_1 = function $$initialize() {
      var self = this, $writer = nil;

      
      
      $writer = [[]];
      $send(self, 'supervisors=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [Opal.const_get_relative($nesting, 'MilitarySupervisor').$shared()];
      $send(self, 'military_supervisor=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [Opal.const_get_relative($nesting, 'RoomSupervisor').$shared()];
      $send(self, 'room_supervisor=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      self.$supervisors()['$<<'](self.$room_supervisor());
      return self.$supervisors()['$<<'](self.$military_supervisor());
    }, TMP_WarSupervisor_initialize_1.$$arity = 0);
    Opal.defs(self, '$shared', TMP_WarSupervisor_shared_2 = function $$shared() {
      var $a, $b, self = this;

      
      (Opal.class_variable_set($WarSupervisor, '@@supervisor', ($truthy($a = (($b = $WarSupervisor.$$cvars['@@supervisor']) == null ? nil : $b)) ? $a : self.$new())));
      return (($a = $WarSupervisor.$$cvars['@@supervisor']) == null ? nil : $a);
    }, TMP_WarSupervisor_shared_2.$$arity = 0);
    return (Opal.defn(self, '$tick!', TMP_WarSupervisor_tick$B_4 = function() {
      var TMP_3, self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("WarSupervisor Tick!");
      $send(self.$supervisors(), 'each', [], (TMP_3 = function(s){var self = TMP_3.$$s || this;
if (s == null) s = nil;
      return s['$tick!']()}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3));
      return Opal.const_get_relative($nesting, 'Debug').$debug("WarSupervisor Tock!");
    }, TMP_WarSupervisor_tick$B_4.$$arity = 0), nil) && 'tick!';
  })($nesting[0], null, $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["setup"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  Opal.add_stubs(['$require']);
  
  self.$require("debug");
  self.$require("globals");
  return self.$require("war_supervisor");
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$separator', '$tick!', '$shared', '$print_tasks']);
  
  self.$require("setup");
  self.$require("task_manager");
  return (function($base, $super, $parent_nesting) {
    function $ScreepsEntry(){};
    var self = $ScreepsEntry = $klass($base, $super, 'ScreepsEntry', $ScreepsEntry);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ScreepsEntry_loop_1;

    return Opal.defs(self, '$loop', TMP_ScreepsEntry_loop_1 = function $$loop() {
      var self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$separator("begin loop");
      Opal.const_get_relative($nesting, 'WarSupervisor').$shared()['$tick!']();
      Opal.const_get_relative($nesting, 'TaskManager').$shared().$print_tasks();
      return Opal.const_get_relative($nesting, 'Debug').$separator("end loop");
    }, TMP_ScreepsEntry_loop_1.$$arity = 0)
  })($nesting[0], null, $nesting);
})(Opal);
