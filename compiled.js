...
Opal.modules["debug"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Debug_toggle_quiet_1, TMP_Debug_toggle_2, TMP_Debug_debugging_3, TMP_Debug_debug_4, TMP_Debug_always_log_5, TMP_Debug_separator_6;
    ...
    Opal.defs(self, '$toggle', TMP_Debug_toggle_2 = function $$toggle() {
      var $a, self = this;
    ...
    }, TMP_Debug_toggle_2.$$arity = 0);
    Opal.defs(self, '$debugging', TMP_Debug_debugging_3 = function $$debugging() {
      var $a, $b, self = this;

      return ($truthy($a = (($b = $Debug.$$cvars['@@debugging']) == null ? nil : $b)) ? $a : false)
    }, TMP_Debug_debugging_3.$$arity = 0);
    Opal.defs(self, '$debug', TMP_Debug_debug_4 = function $$debug(msg) {
      var $a, $b, self = this;
    ...
    }, TMP_Debug_debug_4.$$arity = 1);
    Opal.defs(self, '$always_log', TMP_Debug_always_log_5 = function $$always_log(msg) {
      var $a, self = this;
    ...
    }, TMP_Debug_always_log_5.$$arity = 1);
    return Opal.defs(self, '$separator', TMP_Debug_separator_6 = function $$separator(msg) {
      var $a, self = this;
...
Opal.modules["globals"] = function(Opal) {
  ...
  return Opal.const_set($nesting[0], 'FIND_MY_CREEPS', self.$Native(FIND_MY_CREEPS));
};
...
Opal.modules["strategy_supervisor"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$new', '$debug', '$calculate_strategy', '$strategy=', '$-', '$strategy', '$shared']);
  return (function($base, $super, $parent_nesting) {
    function $StrategySupervisor(){};
    var self = $StrategySupervisor = $klass($base, $super, 'StrategySupervisor', $StrategySupervisor);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_StrategySupervisor_shared_1, TMP_StrategySupervisor_tick$B_2, TMP_StrategySupervisor_initialize_3, TMP_StrategySupervisor_calculate_strategy_4, TMP_StrategySupervisor_strategy_5;
    ...
    Opal.defn(self, '$calculate_strategy', TMP_StrategySupervisor_calculate_strategy_4 = function $$calculate_strategy() {
      var self = this;
    ...
    }, TMP_StrategySupervisor_calculate_strategy_4.$$arity = 0);
    return Opal.defs(self, '$strategy', TMP_StrategySupervisor_strategy_5 = function $$strategy() {
      var self = this;

      return self.$shared().$strategy()
    }, TMP_StrategySupervisor_strategy_5.$$arity = 0);
  })($nesting[0], null, $nesting)
};
...
Opal.modules["creep"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    self.$attr_accessor("creep_name", "name", "ttl", "hits", "hits_max", "fatigue", "current_task");
...
Opal.modules["room"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Room_initialize_2, TMP_Room_screeps_room_3, TMP_Room_tick$B_5;

    
    self.$attr_accessor("name", "creeps");
    
    Opal.defn(self, '$initialize', TMP_Room_initialize_2 = function $$initialize(name) {
      ...
      $writer[$rb_minus($writer["length"], 1)];;
      $send(self.$screeps_room().$find(Opal.const_get_relative($nesting, 'FIND_MY_CREEPS')), 'each', [], (TMP_1 = function(creep_obj){var self = TMP_1.$$s || this;
if (creep_obj == null) creep_obj = nil;
      return self.$creeps()['$<<'](Opal.const_get_relative($nesting, 'Creep').$new(creep_obj['$[]']("name")))}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1));
      return Opal.const_get_relative($nesting, 'Debug').$debug("" + "Loaded " + (self.$creeps().$length()) + " creeps in room " + (self.$name()));
    }, TMP_Room_initialize_2.$$arity = 1);
    ...
    return (Opal.defn(self, '$tick!', TMP_Room_tick$B_5 = function() {
      ...
      $send(self.$creeps(), 'each', [], (TMP_4 = function(creep){var self = TMP_4.$$s || this;
if (creep == null) creep = nil;
      return creep['$tick!']()}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4));
      return Opal.const_get_relative($nesting, 'Debug').$debug("" + "Room " + (self.$name()) + " tock!");
    }, TMP_Room_tick$B_5.$$arity = 0), nil) && 'tick!';
  })($nesting[0], null, $nesting);
};
...
/* Generated by Opal 0.11.4 */
Opal.modules["resource_supervisor"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $truthy = Opal.truthy;

  Opal.add_stubs(['$new', '$debug']);
  return (function($base, $super, $parent_nesting) {
    function $ResourceSupervisor(){};
    var self = $ResourceSupervisor = $klass($base, $super, 'ResourceSupervisor', $ResourceSupervisor);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ResourceSupervisor_shared_1, TMP_ResourceSupervisor_tick$B_2, TMP_ResourceSupervisor_initialize_3;

    
    Opal.defs(self, '$shared', TMP_ResourceSupervisor_shared_1 = function $$shared() {
      var $a, $b, self = this;

      
      (Opal.class_variable_set($ResourceSupervisor, '@@supervisor', ($truthy($a = (($b = $ResourceSupervisor.$$cvars['@@supervisor']) == null ? nil : $b)) ? $a : self.$new())));
      return (($a = $ResourceSupervisor.$$cvars['@@supervisor']) == null ? nil : $a);
    }, TMP_ResourceSupervisor_shared_1.$$arity = 0);
    
    Opal.defn(self, '$tick!', TMP_ResourceSupervisor_tick$B_2 = function() {
      var self = this;

      
      Opal.const_get_relative($nesting, 'Debug').$debug("ResourceSupervisor Tick!");
      return Opal.const_get_relative($nesting, 'Debug').$debug("ResourceSupervisor Tock!");
    }, TMP_ResourceSupervisor_tick$B_2.$$arity = 0);
    return (Opal.defn(self, '$initialize', TMP_ResourceSupervisor_initialize_3 = function $$initialize() {
      var self = this;

      return nil
    }, TMP_ResourceSupervisor_initialize_3.$$arity = 0), nil) && 'initialize';
  })($nesting[0], null, $nesting)
};
...
Opal.modules["task_manager"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$new', '$tasks=', '$-', '$debug', '$select', '$tasks', '$==', '$name', '$length', '$>=', '$<', '$<<', '$print_tasks', '$each']);
  return (function($base, $super, $parent_nesting) {
    function $TaskManager(){};
    var self = $TaskManager = $klass($base, $super, 'TaskManager', $TaskManager);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_TaskManager_shared_1, TMP_TaskManager_initialize_2, TMP_TaskManager_add_task_4, TMP_TaskManager_print_tasks_6;
...
if (t == null) t = nil;
      ...
      if ($truthy(($truthy($a = $rb_ge(duplicates_allowed, 1)) ? $rb_lt(desired_tasks.$length(), duplicates_allowed) : $a))) {
        self.$tasks()['$<<'](task)};
      Opal.const_get_relative($nesting, 'Debug').$debug("Printing tasks");
      return self.$print_tasks();
    }, TMP_TaskManager_add_task_4.$$arity = -2);
    return (Opal.defn(self, '$print_tasks', TMP_TaskManager_print_tasks_6 = function $$print_tasks() {
      var TMP_5, self = this;

      return $send(self.$tasks(), 'each', [], (TMP_5 = function(t){var self = TMP_5.$$s || this;
if (t == null) t = nil;
      return Opal.const_get_relative($nesting, 'Debug').$debug(t)}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5))
    }, TMP_TaskManager_print_tasks_6.$$arity = 0), nil) && 'print_tasks';
  })($nesting[0], null, $nesting)
};
...
Opal.modules["task"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$name=', '$-', '$data=', '$completed=', '$debug', '$to_s', '$class', '$name', '$data']);
  return (function($base, $super, $parent_nesting) {
    function $Task(){};
    var self = $Task = $klass($base, $super, 'Task', $Task);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Task_initialize_1, TMP_Task_execute_2, TMP_Task_to_s_3;

    
    self.$attr_accessor("assigned_obj", "assigned_id", "name", "data", "completed");
    
    Opal.defn(self, '$initialize', TMP_Task_initialize_1 = function $$initialize(name, data) {
      var self = this, $writer = nil;
      ...
      return $writer[$rb_minus($writer["length"], 1)];;
    }, TMP_Task_initialize_1.$$arity = 2);
    
    Opal.defn(self, '$execute', TMP_Task_execute_2 = function $$execute(owner) {
      var self = this;

      return Opal.const_get_relative($nesting, 'Debug').$debug("Attempted to execute a task that has not been defined.")
    }, TMP_Task_execute_2.$$arity = 1);
    return (Opal.defn(self, '$to_s', TMP_Task_to_s_3 = function $$to_s() {
      var self = this;

      return "" + (self.$class().$to_s()) + ": " + (self.$name()) + " | Data: " + (self.$data())
    }, TMP_Task_to_s_3.$$arity = 0), nil) && 'to_s';
  })($nesting[0], null, $nesting)
};
...
Opal.modules["strategies/begin_strategy"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$debug', '$each_pair', '$requirements', '$[]', '$>', '$<', '$length', '$create_spawn_task', '$new', '$add_task', '$shared']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defs(self, '$generate_tasks', TMP_BeginStrategy_generate_tasks_3 = function $$generate_tasks(capabilities) {
      ...
      return $send(self.$requirements(), 'each_pair', [], (TMP_2 = function(role, count){var self = TMP_2.$$s || this, $a, $b;
if (role == null) role = nil;if (count == null) count = nil;
      if ($truthy(($truthy($a = ($truthy($b = capabilities['$[]'](role)) ? $rb_gt(count, 0) : $b)) ? $rb_lt(capabilities['$[]'](role).$length(), count) : $a))) {
          
          Opal.const_get_relative($nesting, 'Debug').$debug("" + "count: " + (count) + " | role: " + (role) + " | capabilities[role]: " + (capabilities['$[]'](role).$length()));
...
Opal.modules["population_controller"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_PopulationController_shared_1, TMP_PopulationController_tick$B_2, TMP_PopulationController_generate_tasks_3, TMP_PopulationController_refresh_5, TMP_PopulationController_analyze_capabilities_9, TMP_PopulationController_analyze_creep_10, TMP_PopulationController_print_creeps_by_parts_11, TMP_PopulationController_print_capabilities_12, TMP_PopulationController_initialize_13;

    
    self.$attr_accessor("all_creeps", "creeps_by_parts", "capability_breakdown");
    Opal.defs(self, '$shared', TMP_PopulationController_shared_1 = function $$shared() {
      var $a, $b, self = this;

      
      (Opal.class_variable_set($PopulationController, '@@supervisor', ($truthy($a = (($b = $PopulationController.$$cvars['@@supervisor']) == null ? nil : $b)) ? $a : self.$new())));
      return (($a = $PopulationController.$$cvars['@@supervisor']) == null ? nil : $a);
    }, TMP_PopulationController_shared_1.$$arity = 0);
    ...
    Opal.defn(self, '$refresh', TMP_PopulationController_refresh_5 = function $$refresh() {
      var TMP_4, self = this, $writer = nil;
...
if (creep == null) creep = nil;
    ...
    Opal.defn(self, '$analyze_capabilities', TMP_PopulationController_analyze_capabilities_9 = function $$analyze_capabilities() {
      ...
      $writer[$rb_minus($writer["length"], 1)];;
      return $send(self.$all_creeps(), 'each', [], (TMP_6 = function(creep){var self = TMP_6.$$s || this, TMP_7, TMP_8, creep_roles = nil;
if (creep == null) creep = nil;
      
        $send(creep.$body_parts(), 'each', [], (TMP_7 = function(part){var self = TMP_7.$$s || this, $a, $logical_op_recvr_tmp_1 = nil;
if (part == null) part = nil;
          ...
          return self.$creeps_by_parts()['$[]'](part)['$<<'](creep.$name());}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7));
        creep_roles = self.$analyze_creep(creep);
        return $send(creep_roles, 'each', [], (TMP_8 = function(role){var self = TMP_8.$$s || this, $a, $logical_op_recvr_tmp_2 = nil;
if (role == null) role = nil;
          ...
          return self.$capability_breakdown()['$[]'](role)['$<<'](creep.$creep_name());}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8));}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6));
    }, TMP_PopulationController_analyze_capabilities_9.$$arity = 0);
    
    Opal.defn(self, '$analyze_creep', TMP_PopulationController_analyze_creep_10 = function $$analyze_creep(creep) {
      ...
      if ($truthy(($truthy($a = ($truthy($b = creep.$body_parts()['$include?']("work")) ? creep.$body_parts()['$include?']("carry") : $b)) ? creep.$body_parts()['$include?']("move") : $a))) {
        roles['$<<']("miner")};
      return roles;
    }, TMP_PopulationController_analyze_creep_10.$$arity = 1);
    
    Opal.defn(self, '$print_creeps_by_parts', TMP_PopulationController_print_creeps_by_parts_11 = function $$print_creeps_by_parts() {
      var self = this;
    ...
    }, TMP_PopulationController_print_creeps_by_parts_11.$$arity = 0);
    
    Opal.defn(self, '$print_capabilities', TMP_PopulationController_print_capabilities_12 = function $$print_capabilities() {
      var self = this;
    ...
    }, TMP_PopulationController_print_capabilities_12.$$arity = 0);
    return (Opal.defn(self, '$initialize', TMP_PopulationController_initialize_13 = function $$initialize() {
      var self = this, $writer = nil;
      ...
      $send(self, 'creeps_by_parts=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];;
    }, TMP_PopulationController_initialize_13.$$arity = 0), nil) && 'initialize';
  })($nesting[0], null, $nesting);
};
...
Opal.modules["room_supervisor"] = function(Opal) {
  ...
  self.$require("resource_supervisor");
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_RoomSupervisor_initialize_1, TMP_RoomSupervisor_shared_2, TMP_RoomSupervisor_tick$B_5, TMP_RoomSupervisor_refresh_7;

    
    self.$attr_accessor("rooms", "supervisors");
    ...
    Opal.defn(self, '$initialize', TMP_RoomSupervisor_initialize_1 = function $$initialize() {
      ...
      $writer[$rb_minus($writer["length"], 1)];;
      self.$supervisors()['$<<'](Opal.const_get_relative($nesting, 'ResourceSupervisor').$shared());
      return self.$supervisors()['$<<'](Opal.const_get_relative($nesting, 'PopulationController').$shared());
    ...
    Opal.defn(self, '$tick!', TMP_RoomSupervisor_tick$B_5 = function() {
      var TMP_3, TMP_4, self = this;
...
if (s == null) s = nil;
      ...
      $send(self.$rooms(), 'each', [], (TMP_4 = function(room){var self = TMP_4.$$s || this;
if (room == null) room = nil;
      return room['$tick!']()}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4));
      return Opal.const_get_relative($nesting, 'Debug').$debug("RoomSupervisor Tock!");
    }, TMP_RoomSupervisor_tick$B_5.$$arity = 0);
    return (Opal.defn(self, '$refresh', TMP_RoomSupervisor_refresh_7 = function $$refresh() {
      var TMP_6, self = this, $writer = nil;
...
if (room_name == null) room_name = nil;
        ...
        self.$rooms()['$<<'](new_room);
        return Opal.const_get_relative($nesting, 'ThreatAssessor').$assess(new_room);}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6));
    }, TMP_RoomSupervisor_refresh_7.$$arity = 0), nil) && 'refresh';
  })($nesting[0], null, $nesting);
};
...
Opal.modules["war_supervisor"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_accessor', '$supervisors=', '$-', '$shared', '$strategy_supervisor=', '$military_supervisor=', '$room_supervisor=', '$<<', '$supervisors', '$strategy_supervisor', '$room_supervisor', '$military_supervisor', '$new', '$debug', '$each', '$tick!']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    self.$attr_accessor("supervisors", "strategy_supervisor", "military_supervisor", "room_supervisor");
    ...
    Opal.defn(self, '$initialize', TMP_WarSupervisor_initialize_1 = function $$initialize() {
      ...
      $writer = [Opal.const_get_relative($nesting, 'StrategySupervisor').$shared()];
      $send(self, 'strategy_supervisor=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      ...
      $writer[$rb_minus($writer["length"], 1)];;
      self.$supervisors()['$<<'](self.$strategy_supervisor());
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$separator', '$tick!', '$shared']);
